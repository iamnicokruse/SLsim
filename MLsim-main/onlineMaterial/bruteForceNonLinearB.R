...
# write.csv(betaData, "MLsim-main/utils/bruteForceBcoeff_nonlinear3_rel1.0.csv", row.names=FALSE)
# bruteForceB <- read.table("MLsim-main/utils/bruteForceBcoeff_nonlinear3_rel1.0.csv", header = T, sep = ",")
