...
# write.csv(betaData, "MLsim-main/utils/bruteForceBcoeff_nonlinear3.csv", row.names=FALSE)
# bruteForceB <- read.table("MLsim-main/utils/bruteForceBcoeff_nonlinear3.csv", header = T, sep = ",")
